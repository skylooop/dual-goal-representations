...
flags.DEFINE_string(
    "restore_path", None, "Path to the checkpoint directory (required).", required=True
)
flags.DEFINE_integer(
    "restore_epoch", 1000000, "Checkpoint step to restore (None for latest)."
)
...
# RLiable.
flags.DEFINE_integer(
    "num_bootstraps", 50_000, "Number of bootstrap replicates for CIs."
)
flags.DEFINE_float("confidence_level", 0.95, "Confidence level for bootstrap CIs.")

# Output.
flags.DEFINE_string(
    "save_dir", "eval_results/", "Directory to save evaluation results."
)
