...
class GCIVLVisualDualAgent(flax.struct.PyTreeNode):
    ...
    def rep_loss(self, batch, grad_params):
        ...
        grad_obs, grad_next_obs = (
            self.network.select("state_encoder")(
        ...
        grad_goals = self.network.select("goal_encoder")(
    ...
    def value_loss(self, batch, grad_params):
        ...
        (v1, v2) = self.network.select("value")(
            grad_obs, grad_goal_reps, params=grad_params
        )
        v = (v1 + v2) / 2
    ...
    def create(
        ...
        network_info = dict(
            ...
            rep_critic=(
                rep_critic_def,
                (ex_encoder_outputs, ex_encoder_outputs, ex_actions),
            ),
            target_rep_critic=(
