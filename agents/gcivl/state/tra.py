...
class GCIVLTRAAgent(flax.struct.PyTreeNode):
    ...
    def actor_loss(self, batch, grad_params, rng=None):
        ...
        # Actor gradients are not flowed. This was found to perform better experimentally.
        _, _, goal_reps = self.network.select("contrastive")(
...
def get_config():
    config = ml_collections.ConfigDict(
        dict(
            ...
            agent_name="gcivl_tra",  # Agent name.
